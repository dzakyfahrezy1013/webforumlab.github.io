    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="account-wrapper">
          <div class="row">
            <div class="col-lg-12">
              <div class="account-thumb bg_img h-100 d-flex flex-wrap align-items-center justify-content-center rounded-3" style="background-image: url('assets/images/frontend/auth/pemandangan.png')">
                <div class="text-center">
                  <h2 class="text-white">@lang('Selamat Datang Di') {{ __(@$general->sitename) }}</h2>
